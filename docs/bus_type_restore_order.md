...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/bus_type_restore_order.html"
...
| --- |
| Note |
| Veeam Plug-in for Nutanix AHV takes into account the bus type restore priority only when performing the following operations:   * [Restore of an entire VM](restore_to_ahv.md) that originally resided on a platform other than Nutanix AHV. * [Instant Recovery of any VM](instant_recovery.md) (including Nutanix AHV VMs) to Nutanix AHV. |
...
1. In a web browser, log in to the Host Management web console as described in the Veeam Backup & Replication User Guide, section [Accessing Host Management Console](https://helpcenter.veeam.com/docs/vbr/userguide/hmc_access.html?ver=13).
...
The default location of Nutanix AHV plug-in is C:\Program Files\Veeam\Plugins\Nutanix AHV. However, the location may differ depending on the [specified setup settings](install_ahv_services.md).

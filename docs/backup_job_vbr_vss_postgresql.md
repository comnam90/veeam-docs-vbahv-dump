...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/backup_job_vbr_vss_postgresql.html"
...
* Select the Until the corresponding image-level backup is deleted option if you want to remove WAL log backups and the related image-level backups at the same time, according to the retention policy settings specified at [step 4](backup_job_vbr_destination.md) of the wizard.
...
Depending on the scope of resources that you have specified at [step 5a](backup_job_vbr_vss_application.md) of the wizard, Veeam Backup & Replication will use the selected account in the following way:
...
![PostgreSQL WAL Files Settings](images/backup_job_vbr_vss_postgresql.webp)

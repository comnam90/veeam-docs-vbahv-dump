...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/backup_job_vbr_vss_sql.html"
...
* Select the Until the corresponding image-level backup is deleted option if you want to remove transaction log backups and the related image-level backups at the same time, according to the retention policy settings specified at [step 4](backup_job_vbr_destination.md).
...
![Microsoft SQL Server Transaction Log Settings](images/backup_job_vbr_vss_sql.webp)

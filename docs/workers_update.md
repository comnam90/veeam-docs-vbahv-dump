...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/workers_update.html"
...
1. At the Networks step of the Edit Nutanix AHV Worker wizard, click Advanced and clear the Check for updates online check box. Then, click Finish to save changes made to the worker settings.
   ...
   ![Disabling Automatic Worker Updates](images/workers_update.webp "Updating Workers")

...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/workers_add_network.html"
...
1. Repeat steps 1–2 to add more network interfaces. For more information on multi-network configuration, see section [Appendix. Configuring Multiple Networks](multiple_networks.md).
...
![Step 3. Configure Network Settings](images/workers_add_network.webp "Specify Worker Network Settings")

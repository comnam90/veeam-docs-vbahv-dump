...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/backup_job_vbr_vss_oracle.html"
...
* Select the Until the corresponding image-level backup is deleted option if you want to remove archived redo log backups and the related image-level backups at the same time, according to the retention policy settings specified at [step 4](backup_job_vbr_destination.md).
...
![Oracle Archived Redo Log Settings](images/backup_job_vbr_vss_oracle.webp)

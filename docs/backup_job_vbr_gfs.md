...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/backup_job_vbr_gfs.html"
...
After you configure the GFS retention policy settings, [schedule active full or synthetic full backups](backup_job_vbr_advanced.md). Otherwise, no new full backups will be automatically produced, and Veeam Backup & Replication will be unable to leverage them for long-term retentions.
...
![Configuring GFS Policy Schedules](images/backup_job_add_vbr_destination_gfs.webp "Configuring GFS Policy Schedules")

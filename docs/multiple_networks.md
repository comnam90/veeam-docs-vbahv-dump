...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/multiple_networks.html"
...
[![Network diagram 1](images/multiple_networks_a_b_ok2.webp)](images/multiple_networks_a_b_ok2.webp "Network diagram 1")

Example 2. Valid Configuration

In this example, the workers, the backup server, the repository and the Nutanix AHV cluster are connected to Network A, while the workers and the backup repository are also connected to Network B that is [configured as a preferred network](https://helpcenter.veeam.com/docs/vbr/userguide/select_backup_network.html?ver=13) to deliver traffic to the backup repository. This configuration is valid since all backup infrastructure components are connected to the same network.
...
[![Network diagram 2](images/multiple_networks_a_b_ok.webp)](images/multiple_networks_a_b_ok.webp "Network diagram 2")
...
[![Network diagram 3](images/multiple_networks_router.webp)](images/multiple_networks_router.webp "Network diagram 3")
...
[![Network diagram 4](images/multiple_networks_a_b_c.webp)](images/multiple_networks_a_b_c.webp "Network diagram 4")

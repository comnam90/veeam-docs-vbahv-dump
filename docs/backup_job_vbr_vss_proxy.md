...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/backup_job_vbr_vss_proxy.html"
...
| --- |
| Important |
| Due to technical limitations, Linux-based proxies cannot access Windows guest OSes in the current version. That is why if you have added Windows-based VMs to the backup scope at [step 3](backup_job_vbr_assign_vms.md) of the wizard, you must also add at least one Microsoft Windows server to the backup infrastructure. |

![Step 5c. Choose Guest Interaction Proxy](images/backup_job_vbr_vss_proxy.webp)

...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/infrastructure_components.html"
...
* [Prism Central deployment scenario](infrastructure_prism_central.md) allows you to protect workloads that reside in multiple clusters registered with a Prism Central.
...
* [Standalone cluster deployment scenario](infrastructure_cluster.md) allows you to protect workloads that reside in a specific cluster.

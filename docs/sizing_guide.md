...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/sizing_guide.html"
...
| --- |
| Important |
| To modify the worker settings, use the Veeam Backup & Replication console as described in section [Disabling Automatic Worker Updates](workers_update.md). Allocating resources to the VM running as a worker in the Nutanix Prism console may cause technical issues. |

...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/active_full_backup.html"
...
* [Creating Active Full Backup](creating_active_full_backup.md)
* [Creating Backup Jobs](backup_job_vbr_schedule.md)

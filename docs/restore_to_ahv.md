...
product: "vbahv"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vbahv/userguide/restore_to_ahv.html"
...
1. [Check prerequisites and limitations](restore_to_ahv_byb.md).
2. [Launch the Full VM Restore wizard](restore_to_ahv_launch.md).
3. [Select VMs to restore](restore_to_ahv_select_vms.md).
4. [Choose a restore mode](restore_to_ahv_mode.md).
5. [Specify a target cluster](restore_to_ahv_target_cluster.md).
6. [Select a storage container where VM virtual disks will be stored](restore_to_ahv_container.md).
7. [Specify a new name for the restored VM](restore_to_ahv_vm_name.md).
8. [Configure network settings](restore_to_ahv_network.md).
9. [Specify a restore reason](restore_to_ahv_reason.md).
10. [Verify restore settings](restore_to_ahv_summary.md).
